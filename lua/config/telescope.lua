...
vim.keymap.set('n', '<leader>fF', "<Cmd>lua require('telescope.builtin').git_files()<CR>", { noremap = true, silent = true })
...
vim.keymap.set('n', '<leader>fm', "<Cmd>lua require('telescope.builtin').oldfiles()<CR>", { noremap = true, silent = true })
vim.keymap.set('n', '<leader>fM', "<Cmd>lua require('telescope.builtin').keymaps()<CR>", { noremap = true, silent = true })
vim.keymap.set('n', '<leader>f/', "<Cmd>lua require('telescope.builtin').search_history()<CR>", { noremap = true, silent = true })
